...
public class Runner {
    ...
    private String[] getOrDefault(final String[] additionalProperties, final String[] additionalPropertiesDefault) {
        return additionalProperties == null ? additionalPropertiesDefault : additionalProperties;
    }

    private String getOrDefault(final Map<String, String> userInput, final String key, final String defaultValue) {
